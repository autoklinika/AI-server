...
exec env RELEASE_STAGE=O RELEASE_MIGRATION=crt-projection-v1 \
  RELEASE_OBSERVABILITY_CONTRACT=1 RELEASE_KNOWLEDGE_CONTRACT=1 \
  RELEASE_CRT_CONTRACT=1 RELEASE_ERS_CONTRACT=1 RELEASE_CONTROL_CENTER_CONTRACT=1 \
  RELEASE_MIGRATION_TOOLING=1 \
